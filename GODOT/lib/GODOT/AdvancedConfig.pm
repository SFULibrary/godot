...
##
## (16-mar-2015 kl) - added issns for both 'dissertations abstracts' and 'masters abstracts' as per 27-feb-2015 sw email
##

my @dissertation_abstracts_issn = qw(00993213 10644687 03076075 04194217 0420073X 00959154 10427279 04194209 00959154);
my @masters_abstracts_issn = qw(00255106 08989095);

use vars qw(@DISS_ABS_ISSN_ARR);
@DISS_ABS_ISSN_ARR = (@dissertation_abstracts_issn, @masters_abstracts_issn);
...
##
## (13-nov-2009 kl) -- changed to $TRUE as useful for troubleshooting;
##
